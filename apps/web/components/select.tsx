...
/**
 * Select — Radix-backed. Trigger uses the design system's input radius (12dp)
 * and neutral border; menu mirrors the Card surface. Brand focus ring.
 */
