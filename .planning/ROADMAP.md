...
| 7. Pending-Failed Links Screen | 0/1 | Planned | - |
...
Plans:
- [ ] 07-01-PLAN.md — FailedPendingLink export + 순수 표시 헬퍼(사유 한국어 매핑 D-04 + 상대시각) + failed.tsx 라우트 화면(리스트·사유배지·재시도·전체재시도·스와이프 삭제·실행취소·empty state, D-01~D-08) + boards.tsx 배너 타깃 수정(/boards/_failed → /boards/failed) + 단위/렌더 테스트 [Wave 1]
