...
**Plans:** 4 plans
  - [ ] 01-01-PLAN.md — Brand asset SVG sources + sharp export script + Pretendard 폰트 (iOS+Web) + pnpm hoist scope + NativeWind 4.2 upgrade [BUILD-03]
  ...
  - [ ] 01-03-PLAN.md — next/font/local Pretendard + lib/env.ts + dev-tool 이중 게이트 (page redirect + component null) [WEB-01/02 + BUILD-03 web]
