...
- [~] **Phase 5: Trust UI & Onboarding** — AI vs 수동 시각 구분 + 진행상태 UI + 실패 retry + low_confidence + 첫 보드 자동 + 안내 카드 (Wave 1+2+3 complete — 4/6)
...
| 5. Trust UI & Onboarding | 4/6 | In progress (Wave 1+2+3 done) | - |
