// apps/ios/app/me.tsx
// Phase 17 (A4) — "내 정보" relocated from (tabs)/me.tsx to a trip-out GLOBAL
// stack screen. The trip header's profile glyph routes here via router.push('/me').
// Content is the existing profile screen verbatim (NAV-03 surgical relocation).
...
/**
 * "내 정보" screen. Profile hero card → editable profile fields (닉네임/성별/생일,
        ...
        <View className="px-5 pt-6 pb-24">
          <View className="flex-row items-center px-2 mb-4">
            <Pressable
              ...
              className="w-9 h-9 -ml-2 items-center justify-center"
            >
              <Ionicons name="chevron-back" size={24} color="#374151" />
            </Pressable>
            <Text className="text-2xl font-extrabold tracking-tight text-neutral-900">
              내 정보
            </Text>
          </View>
