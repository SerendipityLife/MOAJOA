...
- **모닝 게이트 진행 (2026-06-12 자율 세션):** db push 0008~0010 ✅ 적용 · types 재생성 ✅ · extract-youtube 배포 ✅ · 블로그 추출 풀 파이프라인 라이브 검증 ✅ (10곳, conf 0.94, 환각 0) · IG 명시적 실패 ✅ · join_shared_board+투표+shared 가시성 ✅ · 보안(anon 401/ready 409) ✅. **남은 사용자 판단:** ① YOUTUBE_API_KEY 발급(유튜브 추출 차단 해소 — 유일한 경로) ② migration 0011 prod 적용(확정 분모 owner 포함) ③ 실기기 검증(09-05 iOS + 10-03 확정 토글). 상세: `docs/SESSION-NOTES-2026-06-12.md`.
