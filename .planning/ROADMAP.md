...
- [ ] 18-05-PLAN.md — plan.tsx States A–F(버튼→스켈레톤→초안) + 드래그 재배치 + 미배치 풀 + 필수 앵커 + 협업 토글 + 디바이스 UAT (Wave 3) — 코드 완료(jest 79/79 + typecheck 0, commits 5a454b9/cb63909/b461d05), 디바이스 UAT 대기
**UI hint**: yes
