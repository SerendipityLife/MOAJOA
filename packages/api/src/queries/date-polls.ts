 ...
 * (`am_trip_owner(trip_id)`, 0030 — was can_edit_trip/0018) — no new RPC. poll_code is
 ...
 * (`am_trip_owner(trip_id)`, 0030). No new RPC needed; a non-owner
 ...
 * (`am_trip_owner(trip_id)`, 0030) — no new RPC. The plan-tab card locks
